...
CREATE TABLE [refresh_tokens] (
    ...
    [replaced_by_token_hash] nvarchar(max) NULL,
    CONSTRAINT [pk_refresh_tokens] PRIMARY KEY ([id]),
    CONSTRAINT [fk_refresh_tokens__users_user_id] FOREIGN KEY ([user_id]) REFERENCES [users] ([id]) ON DELETE NO ACTION
);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260604020249_AddRefreshTokens', N'10.0.8');
...
CREATE TABLE [revoked_access_tokens] (
    ...
    [expires_at] datetime2 NOT NULL,
    [revoked_at] datetime2 NOT NULL,
    CONSTRAINT [pk_revoked_access_tokens] PRIMARY KEY ([id])
);

CREATE UNIQUE INDEX [ix_revoked_access_tokens_jwt_id] ON [revoked_access_tokens] ([jwt_id]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260604020636_AddRevokedAccessTokens', N'10.0.8');
